...
/// @title PunchSwap V3 Staker Interface
/// @notice Allows staking nonfungible liquidity tokens in exchange for reward tokens
interface IPunchSwapV3Staker is IERC721Receiver, IMulticall {
    /// @param rewardToken The token being distributed as a reward
    /// @param pool The PunchSwap V3 pool
    ...
    /// @notice The UnisPunchSwapap V3 Factory
    function factory() external view returns (IPunchSwapV3Factory);
    ...
    /// @notice Withdraws a PunchSwap V3 LP token `tokenId` from this contract to the recipient `to`
    ...
    /// @notice Event emitted when a PunchSwap V3 LP token has been staked
    /// @param tokenId The unique identifier of an PunchSwap V3 LP token
    /// @param liquidity The amount of liquidity staked
    /// @param incentiveId The incentive in which the token is staking
    event TokenStaked(uint256 indexed tokenId, bytes32 indexed incentiveId, uint128 liquidity);

    /// @notice Event emitted when a PunchSwap V3 LP token has been unstaked
    /// @param tokenId The unique identifier of an PunchSwap V3 LP token
    /// @param incentiveId The incentive in which the token is staking
