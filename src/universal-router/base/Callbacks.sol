...
import {IERC721Receiver} from '@openzeppelin-53/contracts/token/ERC721/IERC721Receiver.sol';
import {IERC1155Receiver} from '@openzeppelin-53/contracts/token/ERC1155/IERC1155Receiver.sol';
import {IERC165} from '@openzeppelin-53/contracts/utils/introspection/IERC165.sol';
